...
if ($device['os_group'] == 'cisco') {
    ...
    $tblChassis = snmpwalk_array_num($device, '.1.3.6.1.4.1.9.9.719.1.9.35', 2);
     ...
     */
    if ( is_null($tblChassis) || is_null($tblBoard) || is_null($tblFans) || is_null($tblPSU) || is_null($tblMemory) || is_null($tblCPU) || is_null($tblStorage) || is_null($tblDisk) || is_null($tblLUN) || is_null($tblBAT) ) {
