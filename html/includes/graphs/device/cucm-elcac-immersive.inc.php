<?php
/*
 * LibreNMS module to display Cisco CUCM ELCAC Immersive Bandwidth Details
 *
...
$rrd_options .= " -l 0 -E ";
$rrd_options .= " COMMENT:'Immersive Video Bandwidth (kbps)  Now  Avg  Max\\n'";
...
if (isset($vars['item'])) {
    ...
    if (file_exists($rrd_filename)) {
        $rrd_options .= " DEF:TOT" . $count . "=" . $rrd_filename . ":totalimmersive:AVERAGE";
        $rrd_options .= " DEF:AVA" . $count . "=" . $rrd_filename . ":availableimmersive:AVERAGE";
