<?php
/*
 * LibreNMS module to display Cisco CUCM Unicast Music on Hold Details
 *
...
$rrd_options .= " -l 0 -E ";
$rrd_options .= " COMMENT:'MOH Unicast Resources      Now   Avg   Max\\n'";

foreach ($components as $id => $array) {
    if ($array['label'] == 'MOHUnicastResources') {
