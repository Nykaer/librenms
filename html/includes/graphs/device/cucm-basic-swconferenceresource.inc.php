<?php
/*
 * LibreNMS module to display Cisco CUCM Software Conference Resource Details
 *
...
$rrd_options .= " -l 0 -E ";
$rrd_options .= " COMMENT:'Software Conferencing     Now   Avg   Max\\n'";

foreach ($components as $id => $array) {
    if ($array['label'] == 'SWConferenceResource') {
        ...
        if (file_exists($rrd_filename)) {
            ...
            $rrd_options .= " AREA:DS1" . $count . "#" . $config['graph_colours']['mixed'][2] . ":'Resources Total      '";
            ...
            $rrd_options .= " AREA:DS2" . $count . "#" . $config['graph_colours']['mixed'][4] . ":'Resources Active     '";
