...
foreach ($COMPONENTS as $ID => $ARRAY) {
    if ($ARRAY['label'] == 'Calls') {
        ...
        if (file_exists($rrd_filename)) {
            ...
            $rrd_additions .= " AREA:DS1" . $COUNT . "#" . $COLORS[0] . ":'" . end_spacer ('Total Calls', 15) . "'";
            ...
            $rrd_additions .= " AREA:DS2" . $COUNT . "#" . $COLORS[1] . ":'" . end_spacer ('Video Calls', 15) . "'";
            ...
            $rrd_additions .= " AREA:DS3" . $COUNT . "#" . $COLORS[2] . ":'" . end_spacer ('Encrypted Calls', 15) . "'";
