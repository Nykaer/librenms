...
foreach ($COMPONENTS as $ID => $ARRAY) {
    if ($ARRAY['label'] == 'Calls') {
        ...
        if (file_exists($rrd_filename)) {
            ...
            $rrd_additions .= " DEF:DS1" . $COUNT . "=" . $rrd_filename . ":calls:AVERAGE ";
            $rrd_additions .= " AREA:DS1" . $COUNT . "#" . $config['graph_colours']['mixed'][2] . ":'Total Calls    '";
            ...
            $rrd_additions .= " DEF:DS2" . $COUNT . "=" . $rrd_filename . ":videocalls:AVERAGE ";
            $rrd_additions .= " AREA:DS2" . $COUNT . "#" . $config['graph_colours']['mixed'][4] . ":'Video Calls    '";
            ...
            $rrd_additions .= " DEF:DS3" . $COUNT . "=" . $rrd_filename . ":encryptedcalls:AVERAGE ";
            $rrd_additions .= " AREA:DS3" . $COUNT . "#" . $config['graph_colours']['mixed'][1] . ":'Encrypted Calls'";
